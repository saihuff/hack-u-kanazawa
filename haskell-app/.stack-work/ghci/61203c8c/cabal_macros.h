...
/* package haskell-app-0.1.0.0 */
#ifndef VERSION_haskell_app
#define VERSION_haskell_app "0.1.0.0"
#endif /* VERSION_haskell_app */
#ifndef MIN_VERSION_haskell_app
#define MIN_VERSION_haskell_app(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "haskell-app-0.1.0.0-5la6oO7fthJ35Kw75Is2gw-haskell-app"
